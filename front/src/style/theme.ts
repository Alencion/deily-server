...
export const lightTheme = css`
  ...
  --color-ansi-yellow-bright: #e3b342;
  ...
  --shadow-floating-small: 0px 0px 0px 1px #30363d, 0px 6px 12px -3px #01040966,
    0px 6px 18px 0px #01040966;
  --shadow-floating-medium: 0px 0px 0px 1px #30363d, 0px 8px 16px -4px #01040966,
  ...
  --shadow-floating-legacy: 0px 6px 12px -3px #01040966,
    0px 6px 18px 0px #01040966;
